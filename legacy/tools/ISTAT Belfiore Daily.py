...
def process_files():    # Assign variables as needed
    ...
    # Define hotel specific ID's, bed count hotel service, bed count student service
    ...
    utcTimeStart = get_utc_time(timezoneName, Yesterday)
    utcTimeFinish = get_utc_time(timezoneName, Today)
